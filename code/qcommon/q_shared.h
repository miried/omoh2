...
#ifdef STANDALONE
  #define PRODUCT_NAME			"omoh2"
  #define BASEGAME			"main"
  #define CLIENT_WINDOW_TITLE     	"openmohaa 2"
  #define CLIENT_WINDOW_MIN_TITLE 	"OMoH2"
  #define HOMEPATH_NAME_UNIX		".omoh2"
  #define HOMEPATH_NAME_WIN		"OMoH2"
  #define HOMEPATH_NAME_MACOSX		HOMEPATH_NAME_WIN
  #define GAMENAME_FOR_MASTER		"mohaa"	// must NOT contain whitespace
